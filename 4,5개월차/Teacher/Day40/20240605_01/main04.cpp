...
void CreateGraph()
{
	...
	// a를 6개 사이즈로 늘리고, 그안의 벡터들을 각각 6개 사이즈에 값을 -1로 한다.
...
void Dijikstar(int start)
{
	// 1. BFS 기반
	// 2. - BFS -> Queue
	//    - dijikstar -> priority_queue


	// priority_queue 특징 (트리) (값이 추가/ 삭제) (루트에 넣어두고 도장깨기를 하던 / 뿌리에 넣어두고 역도장깨기를하던)
	//   -> 내부에서  < 연산자를 사용.
